    ...
    {
        {
            ...
            return view('welcomeBo', compact('linkNav', 'socialNav', 'infoNav', 'footer','footerCopyright', 'footerDesign', 'hero', 'about', 'aboutList', 'facts', 'factsList', 'skills', 'skillsList', 'resume', 'resumePro', 'resumeSummaries', 'resumeEducation', 'portfolio', 'portfolioList', 'portfolioPic', 'contact', 'contactList'));
        }
    }
}
