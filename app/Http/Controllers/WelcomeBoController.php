    ...
    {
        {
            ...
            return view('welcomeBo', compact('linkNav', 'socialNav', 'infoNav', 'footer', 'hero', 'about', 'aboutList', 'facts', 'factsList', 'skills', 'skillsList', 'resume', 'resumePro', 'resumeSummaries', 'resumeEducation'));
        }
    }
}
